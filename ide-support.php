...
class R
{
	...
	*/
	...
	public static function convertBeanToArray($beans){
	}
	...
	public static function checkDecaredClass($class){
	}
	
	
	public static function xdispense($type){
	}
	...
	public static function assignItem2Column($arrColumn, $obj){
	}
	...
	public static function savelog( $log,$userid='system'){
	}
	
	public static function showsystemlog($userid='system'){
	}
	
	// public static function clearsystemlog($userid) {
	public static function clearsystemlog($userid='system'){
	}
	...
	* */
	...
	public static function insert($tableName, $rankableColumn, $orderByColumn, $ascDesc =	'DESC', $sqlVarName = 'rankNum'){
	}
	...
	*/
	...
	public static function xgetAll($tbname, $where = null, $arrayparam = null, $type = null,	$format = null ,$userid='system' ){
	}
	...
	public static function xCount($tbname){
	}
